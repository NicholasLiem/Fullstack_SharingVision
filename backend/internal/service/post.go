...
type PostService interface {
	...
	GetPagedPost(limit int, offset int) (*[]datastruct.Post, *utils.HttpError)
}
...
func (ps *postService) GetPagedPost(limit int, offset int) (*[]datastruct.Post, *utils.HttpError) {
